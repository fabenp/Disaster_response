...
@app.route('/index')
def index():  
    """  extract data needed for plotting two graphs: one with the percentage of all the categries from the total of related messages  and the  second with the percentage of each weather disaster compared to the total number of weather disasters"""

...
def index():
    ...
    # data for plotting the percentage of weather disaster compared to the total number of weather disasters
    ...
    # data needed to plot the percentages of the types of messages. All columns related to weather were dropped since the column' rleated to           weather" is the sum of them
